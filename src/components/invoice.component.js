...
import InvoiceDataService from "../services/patient.service";
...
export default class Invoice extends Component {
  ...
  updateActive(status) {
    ...
    InvoiceDataService.update(this.state.currentPatient.id, data)
      .then((response) => {
        this.setState((prevState) => ({
          currentPatient: {
            ...prevState.currentPatient,
  ...
  deletePatient() {
    InvoiceDataService.delete(this.state.currentPatient.id)
      .then((response) => {
        // console.log(response.data);
